...
?>
    ...
    <div class="panel panel-success">
        ...
        <div class="form-group">
            <label class="control-label col-sm-2" for="pwd">Thời Điểm Tạo</label>
            <div class="col-sm-10"> 
                <input id='timecreate' type="date" class="form-control" />
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-sm-2" for="pwd">Tài Khoản Người Giới Thiệu:</label>
            <div class="col-sm-10"> 
