...
<body>
    <div id="wrapper">
        ...
        <nav style="background-color:#fff" class="navbar navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse h-navbar-default">
                <ul class="nav navbar-nav side-nav h-navbar-default h-ul-border-left h-edit-size">
        ...
        <div id="page-wrapper">
            ...
            <div style="margin:0 auto;display:none;" id="plwmenu">
                <img style="margin-left:50%" src="img/pleasewait/plw.gif" />
            </div>
            <div id="pleasechose">
                <div class="jumbotron">
            ...
            <div id="show" style="display:none">               
                ...
                <div class="panel panel-success">
                    <div class="panel-heading">
                        <h3 id="buyatitle" class="panel-title">
                            <i class="fa fa-calendar-o" style="font-size:20px;"></i> Chính Sách Tái Mua Hàng</span>
                        </h3>
                    </div>
                    <div class="panel-body">
                ...
                <div class="panel panel-success">
                    <div class="panel-heading">
                        <h3 id="childtotaltitle" class="panel-title">Doanh Thu Từ Đại Lý Con</h3>
                    </div>
    ...
    <script>
        ...
        function select_month()
        {
            ...
            $("#childtotaltitle").html("Doanh Thu Từ Đại Lý Con (Thời Gian "+$("#select_month").val()+")");
        $("#buyatitle").html("Doanh Thu Từ Tái Mua Hàng (Thời Gian "+$("#select_month").val()+")");
        }
    </script>
    <script>
        function load_firt_menu() {
            $("#h-menu").html('<img class="h-button-d" style="height:60px;width:70px;" src="img/pleasewait/plwmenu.gif" />');
            $.ajax({
        ...
        function h_show_ul(id) {
            ...
            if (css == "none") {
                ...
                $("#ul" + id).html('<img class="h-button-d" style="height:60px;width:70px;" src="img/pleasewait/plwmenu.gif" />');
